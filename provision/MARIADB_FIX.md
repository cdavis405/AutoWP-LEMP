...
if unix_socket detected:
    ...
    CREATE USER 'admin_retaguide'@'localhost' ...
    MYSQL_CMD="mysql -uadmin_retaguide -p'${DB_PASSWORD}'"
else:
...
- Database 'retaguide_wp' created
- User 'retaguide_user' created with proper privileges
...
sudo mysql -e "CREATE USER 'admin_retaguide'@'localhost' IDENTIFIED BY 'YourPassword'; GRANT ALL PRIVILEGES ON *.* TO 'admin_retaguide'@'localhost' WITH GRANT OPTION; FLUSH PRIVILEGES;"
